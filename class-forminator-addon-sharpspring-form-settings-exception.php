...
/**
 * Class Forminator_Addon_SharpSpring_Form_Settings_Exception
 * Wrapper of Form Settings SharpSpring Exception
 *
 * @since 1.0 SharpSpring Addon
 */
class Forminator_Addon_SharpSpring_Form_Settings_Exception extends Forminator_Addon_SharpSpring_Exception {
	...
	/**
	 * Forminator_Addon_SharpSpring_Form_Settings_Exception constructor.
	 *
	 * Useful if input_id is needed for later.
	 * If no input_id needed, use @see Forminator_Addon_SharpSpring_Exception
	 *
	 * @since 1.0 SharpSpring Addon
	 *
